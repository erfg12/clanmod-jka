...
//		s = "Holocron FFA";
	...
	case GT_JEDIMASTER:
			...
			s = CG_GetStringEdString("MENUS", "JEDIMASTER");//"Jedi Master";??
			//[/OLDGAMETYPES]

//		s = "Jedi Master";
		break;
	case GT_SINGLE_PLAYER:
			s = CG_GetStringEdString("MENUS", "COOP");//"Team FFA";
	...
	case GT_CTY:
		...
		break;
	//RoAR Mod NOTE: RPG Mode.
	/*case GT_RPG:
			s = CG_GetStringEdString("MENUS", "RPG");//"RPG";
