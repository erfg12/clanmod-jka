...
typedef enum {
	...
	PERS_MONK,						// am I a monk? RoAR mod!
	// player awards tracking
	PERS_MONEY,						// persistant money on hand (-at-) -- was PERS_IMPRESSIVE_COUNT, // two railgun hits in a row
	PERS_EXPERIENCE,				// RoAR mod NOTE: RPG mode EXPerience
	PERS_FULLGOD,					//cm Full God
	PERS_SKILL_EARNED,				// assist awards PERS_ASSIST_COUNT
	PERS_ICON,						// kills with the guantlet PERS_GAUNTLET_FRAG_COUNT
	PERS_REGEN						// RoAR mod NOTE: Regen HP and Force when sitting. captures PERS_CAPTURES
} persEnum_t;
...
//RoAR mod BEGIN
typedef enum {			//NOTE: These are in alphabetical order
	CLANICON_NONE,		//Blank, no icon
	CLANICON_BLOOD,
	CLANICON_BOMB,
	CLANICON_CROSS,
	CLANICON_FLOWER,
	...
	CLANICON_JAPANESE,
	CLANICON_LOST,
	CLANICON_MANDALORIAN,
	CLANICON_NUKLEAR,
	CLANICON_NUMBA1,
	CLANICON_PEACE,
	CLANICON_REBEL,
	CLANICON_ROAR,		//Custom made for RoAR members
	CLANICON_SITH,
	CLANICON_SKULL,
	CLANICON_TIE,
	CLANICON_UNHAPPY,
...
typedef enum {			//NOTE: These are in alphabetical order // 2nd layer icons
	CLANICON2_NONE,		//Blank, no icon
	CLANICON2_7CORNERS_RED,
	CLANICON2_7CORNERS_GREEN,
	CLANICON2_7CORNERS_BLUE,
	CLANICON2_DONUTS_RED,
	CLANICON2_DONUTS_GREEN,
	CLANICON2_DONUTS_BLUE,
	CLANICON2_SPARK_RED,
	CLANICON2_SPARK_GREEN,
	CLANICON2_SPARK_BLUE,
	CLANICON2_SPARK_BLACK,
	CLANICON2_STAR_RED,
	CLANICON2_STAR_GREEN,
	CLANICON2_STAR_BLUE,
	CLANICON2_STAR_BLACK,
} clanIcon2_t;
//RoAR mod END
...
// shop item class for bg_buylist (-at-)
typedef enum {
	WC_MELEE,
	WC_PISTOL,
	WC_RIFLE,
...
#define	DF_JK2_YELLOWDFA		64
//#define	DF_LEDGE_GRAB			128
//#define	DF_FORCEKICKFLIP		256 //RoAR mod NOTE: This isnt being used right now...
#define	DF_EASYROLL				512
#define	DF_JK2ROLL				1024
#define	DF_SLIDEONHEADS			2048
#define	DF_MACROSCAN			4096
