...
//En gros, là ça veut dire 0 pour bonne réponse, autre pour naze
//On peut vérifier en DEBUG si on obitent pas de même ABORT( ce qui ne devrait pas arriver )
#define TRUE			1
#define FALSE			0
#define ABORT			0
