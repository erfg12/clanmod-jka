...
bool Board( Vehicle_t *pVeh, bgEntity_t *pEnt )
{
	...
	//RoAR mod NOTE: I cannot allow ppl dueling to jump in a vehicle!
...
void G_VehicleDamageBoxSizing(Vehicle_t *pVeh)
{
	...
	{ //s goh well, DIE!
		//FIXME: does thiive proper credit to the enemy who shot you down?
...
GAME_INLINE void SetParent2( Vehicle_t *pVeh, bgEntity_t *pParentEntity ) { pVeh->m_pParentEntity = pParentEntity; }
...
//	pVehInfo->AnimateRiders					=		AnimateRiders;
	...
	pVehInfo->SetParent2					=		SetParent2;
