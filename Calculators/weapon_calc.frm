...
Begin VB.Form Form1 
   ...
   Caption         =   "Weapons Calculator"
   ClientHeight    =   3240
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   7050
   Icon            =   "WEAPON~1.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   3240
   ...
   Begin VB.TextBox Text2 
      ...
      Left            =   1680
      TabIndex        =   24
      Text            =   "Select the weapons you want to disable."
      Top             =   720
      Width           =   3495
   End
