...
extern gentity_t *NPC_PickEnemy ( void );
...
extern void NPC_GetFlyToGoal( vec3_t moveDir );
extern void NPC_FlyToGoal( void );
...
extern qboolean NPC_ParseParms( char **NPC_Name, gentity_t *NPC/*, qboolean printErrors*/ );
...
extern void NPC_KyleChooseWeapon();
extern void NPC_StandardChooseWeapon();

extern qboolean NPC_TargetVisible2( gentity_t *ent );
