...
// give our items pictures (-at-)
typedef struct buyableClient_s {
	const char *item;
	const char *icon;
	const char *model;
} buyableClient_t;

const buyableClient_t buyableClient[] = 
{
	{	"shield",		"gfx/mp/large_shield",			"models/map_objects/mp/psd.md3" },
	{	"health",		"gfx/hud/i_icon_medkit",		"models/map_objects/mp/medpac.md3" }, // item_medpak_instant
	{	"seeker",		"gfx/hud/i_icon_seeker",		"models/items/remote.md3" }, // item_seeker
	{	"barrier",		"gfx/hud/i_icon_shieldwall",	"models/map_objects/mp/shield.md3" }, // 
	{	"bacta",		"gfx/hud/i_icon_bacta",			"models/map_objects/mp/bacta.md3" }, // item_medpac
	{	"binoculars",	"gfx/hud/i_icon_zoom",			"models/items/binoculars.md3" }, // item_binoculars
	{	"sentry",		"gfx/hud/i_icon_sentrygun",		"" }, // item_sentry_gun
	{	"jetpack",		"gfx/hud/i_icon_jetpack",		"" }, // item_jetpack
	{	"cloak",		"gfx/hud/i_icon_cloak",			"" }, // item_cloak
	{	"health_disp",	"gfx/hud/i_icon_healthdisp",	"models/map_objects/mp/bacta.md3" }, // item_healthdisp
	{	"ammo_disp",	"gfx/hud/i_icon_ammodisp",		"models/map_objects/mp/bacta.md3" }, // item_ammodisp
	{	"stun",			"gfx/hud/w_icon_stunbaton",		"models/weapons2/stun_baton/baton.md3" }, // weapon_stun_baton
	{	"melee",		"gfx/hud/w_icon_melee",			"models/weapons2/stun_baton/baton.md3" }, // weapon_melee
	{	"saber",		"gfx/hud/w_icon_lightsaber",	"models/weapons2/saber/saber_w.md3" }, // weapon_saber
	{	"pistol",		"gfx/hud/w_icon_blaster_pistol","models/weapons2/blaster_pistol/blaster_pistol.md3" }, // weapon_blaster_pistol/weapon_bryar_pistol
	{	"concussion",	"gfx/hud/w_icon_c_rifle",		"models/weapons2/concussion/c_rifle.md3" }, // weapon_concussion_rifle
	{	"dpistol",		"gfx/hud/w_icon_briar",			"models/weapons2/briar_pistol/briar_pistol.md3" }, // weapon_bryar_pistol
	{	"blaster",		"gfx/hud/w_icon_blaster",		"models/weapons2/blaster_r/blaster.md3" }, // weapon_blaster
	{	"disruptor",	"gfx/hud/w_icon_disruptor",		"models/weapons2/disruptor/disruptor.md3"}, // weapon_disruptor
	{	"bowcaster",	"gfx/hud/w_icon_bowcaster",		"models/weapons2/bowcaster/bowcaster.md3" }, // weapon_bowcaster
	{	"repeater",		"gfx/hud/w_icon_repeater",		"models/weapons2/heavy_repeater/heavy_repeater.md3" }, // weapon_repeater
	{	"electro",		"gfx/hud/w_icon_demp2",			"models/weapons2/demp2/demp2.md3" }, // weapon_demp2
	{	"flechette",	"gfx/hud/w_icon_flechette",		"models/weapons2/golan_arms/golan_arms.md3" }, // weapon_flechette
	{	"launcher",		"gfx/hud/w_icon_merrsonn",		"models/weapons2/merr_sonn/merr_sonn.md3" }, // weapon_rocket_launcher
	{	"thermal",		"gfx/hud/w_icon_thermal",		"models/weapons2/thermal/thermal.md3" }, // ammo_thermal
	{	"mine",			"gfx/hud/w_icon_tripmine",		"models/weapons2/laser_trap/laser_trap.md3" }, // ammo_tripmine
	{	"detpack",		"gfx/hud/w_icon_detpack",		"" }, // ammo_detpack
	{	"force",		"gfx/hud/w_icon_blaster",		"" }, // ammo_force
	{	"energy",		"gfx/hud/i_icon_battery",		"" }, // ammo_blaster
	{	"powercells",	"gfx/mp/ammo_power_cell",		"" }, // ammo_powercell
	{	"bolts",		"gfx/mp/ammo_metallic_bolts",	"" }, // ammo_metallic_bolts
	{	"rockets",		"gfx/mp/ammo_rockets",			"" }, // ammo_rockets
	{	"ammodisp",		"gfx/hud/i_icon_ammodisp",		"" }, // item_ammodisp
	{	"healthdisp",	"gfx/hud/i_icon_healthdisp",	"" }, // item_healthdisp
	{	"",		"", "" }, // 

	
	{	NULL,			"gfx/hud/mpi_rflag_x.tga",		"" }, // if nothing is found
};
...
static const serverFilter_t serverFilters[] = {
	{"MENUS_ALL", "" },
	{"MENUS_JEDI_ACADEMY", "" },
	{"MENUS_CLANMOD_SERVER", "clanmod"}, //RoAR mod NOTE: This way we can see all the Clan Mod servers!
};
...
#ifndef _XBOX	
	// draw cursor
	//RoAR mod NOTE: Don't show on map load!
	/*UI_SetColor( NULL );
	if (Menu_Count() > 0) {
...
static const char* UI_GetGameTypeName(int gtEnum)
{
	...
	/*case GT_RPG:
		return UI_GetStringEdString("MENUS", "RPG");//"RPG";*/
	}
...
//lmo added to enhance voting

static void UI_BuildVoteList()
{ // lmo... grunt!
	uiInfo.voteCount = ui_votecount.integer;
	Q_strncpyz(uiInfo.votes[0], ui_vote1.string, MAX_NAME_LENGTH);
	Q_strncpyz(uiInfo.votes[1], ui_vote2.string, MAX_NAME_LENGTH);
	Q_strncpyz(uiInfo.votes[2], ui_vote3.string, MAX_NAME_LENGTH);
	Q_strncpyz(uiInfo.votes[3], ui_vote4.string, MAX_NAME_LENGTH);
	Q_strncpyz(uiInfo.votes[4], ui_vote5.string, MAX_NAME_LENGTH);
	Q_strncpyz(uiInfo.votes[5], ui_vote6.string, MAX_NAME_LENGTH);
}
...
static void UI_Update(const char *name) {
	...
	//cm - Dom Added Rank
 	...
 	/*} else if (Q_stricmp(name, "ui_SetClan") == 0) {
		trap_Cvar_Set( "clan", UI_Cvar_VariableString("ui_clan"));
 	} else if (Q_stricmp(name, "ui_SetRank") == 0) {
		trap_Cvar_Set( "rank", UI_Cvar_VariableString("ui_rank"));*/
 	} else if (Q_stricmp(name, "ui_SetClanIcon") == 0) {
		trap_Cvar_Set( "c_clanicon", UI_Cvar_VariableString("ui_clanicon"));
 	} else if (Q_stricmp(name, "ui_SetClanIcon2") == 0) {
		trap_Cvar_Set( "c_clanicon2", UI_Cvar_VariableString("ui_clanicon2"));
	//RoAR mod [Admin CP]
	...
	} else if (Q_stricmp(name, "ui_SetCSPrint") == 0) {
		trap_Cmd_ExecuteText( EXEC_APPEND, va("csprint all \"%s\"\n", UI_Cvar_VariableString("ui_admincsprint")) );
	} else if (Q_stricmp(name, "ui_SetTeleu2xyz") == 0) {
		//RoAR mod NOTE: In testing this over a 2 day period, I have come to the conclusion that
		//You cannot put multiple cvars on one line when using these UI_'s. You must make multiple
		//lines for multiple cvar variables, when u are finished, you simply end with a return "\n"
		trap_Cmd_ExecuteText( EXEC_APPEND, va("teleport \"%s\"",UI_Cvar_VariableString("ui_teleu2x")) );
		trap_Cmd_ExecuteText( EXEC_APPEND, va("\"%s\"",UI_Cvar_VariableString("ui_teleu2y")) );
		trap_Cmd_ExecuteText( EXEC_APPEND, va("\"%s\"\n",UI_Cvar_VariableString("ui_teleu2z")) );
	} else if (Q_stricmp(name, "ui_SetTelec2xyz") == 0) {
		if (uiInfo.playerIndex >= 0 && uiInfo.playerIndex < uiInfo.playerCount) {
			trap_Cmd_ExecuteText( EXEC_APPEND, va("teleport \"%s\"",uiInfo.playerIndexes[uiInfo.playerIndex]) );
			trap_Cmd_ExecuteText( EXEC_APPEND, va("\"%s\"",UI_Cvar_VariableString("ui_telec2x")) );
			trap_Cmd_ExecuteText( EXEC_APPEND, va("\"%s\"",UI_Cvar_VariableString("ui_telec2y")) );
			trap_Cmd_ExecuteText( EXEC_APPEND, va("\"%s\"\n",UI_Cvar_VariableString("ui_telec2z")) );
		}
	} else if (Q_stricmp(name, "ui_SetTeleclient1client2") == 0) {
		trap_Cmd_ExecuteText( EXEC_APPEND, va("teleport \"%s\"",UI_Cvar_VariableString("ui_telecone")) );
		trap_Cmd_ExecuteText( EXEC_APPEND, va("\"%s\"\n",UI_Cvar_VariableString("ui_telectwo")) );
	} else if (Q_stricmp(name, "ui_Teleu2c2") == 0) {
		if (uiInfo.playerIndex >= 0 && uiInfo.playerIndex < uiInfo.playerCount) {
			trap_Cmd_ExecuteText( EXEC_APPEND, va("teleport %i\n",uiInfo.playerIndexes[uiInfo.playerIndex]) );
		}
	...
	/*else if (Q_stricmp(name, "ui_GetClan") == 0) 
	{
		trap_Cvar_Set( "ui_clan", UI_Cvar_VariableString("clan"));
	}
	//cm - Dom Added Rank
	else if (Q_stricmp(name, "ui_GetRank") == 0) 
	{
		trap_Cvar_Set( "ui_rank", UI_Cvar_VariableString("rank"));
	}*/
	//RoAR mod [Admin CP]
	else if (Q_stricmp(name, "ui_GetAdminPass") == 0) 
	{
		trap_Cvar_Set( "ui_adminpass", UI_Cvar_VariableString("c_Adminpassword"));
	}
...
static void UI_RunMenuScript(char **args) 
{
	...
	if (String_Parse(args, &name)) 
	{
		...
		//RoAR mod [Admin CP]
		} else if (Q_stricmp(name, "ACPslap") == 0) {
			if (uiInfo.playerIndex >= 0 && uiInfo.playerIndex < uiInfo.playerCount) {
				//trap_Cmd_ExecuteText( EXEC_APPEND, va("callvote kick \"%s\"\n",uiInfo.playerNames[uiInfo.playerIndex]) );
				trap_Cmd_ExecuteText( EXEC_APPEND, va("slap \"%i\"\n",uiInfo.playerIndexes[uiInfo.playerIndex]) );
			}
		} else if (Q_stricmp(name, "ACPsleep") == 0) {
			if (uiInfo.playerIndex >= 0 && uiInfo.playerIndex < uiInfo.playerCount) {
				//trap_Cmd_ExecuteText( EXEC_APPEND, va("callvote kick \"%s\"\n",uiInfo.playerNames[uiInfo.playerIndex]) );
				trap_Cmd_ExecuteText( EXEC_APPEND, va("sleep \"%i\"\n",uiInfo.playerIndexes[uiInfo.playerIndex]) );
			}
		} else if (Q_stricmp(name, "ACPlockname") == 0) {
			if (uiInfo.playerIndex >= 0 && uiInfo.playerIndex < uiInfo.playerCount) {
				//trap_Cmd_ExecuteText( EXEC_APPEND, va("callvote kick \"%s\"\n",uiInfo.playerNames[uiInfo.playerIndex]) );
				trap_Cmd_ExecuteText( EXEC_APPEND, va("lockname \"%i\"\n",uiInfo.playerIndexes[uiInfo.playerIndex]) );
			}
		} else if (Q_stricmp(name, "ACPsplat") == 0) {
			if (uiInfo.playerIndex >= 0 && uiInfo.playerIndex < uiInfo.playerCount) {
				//trap_Cmd_ExecuteText( EXEC_APPEND, va("callvote kick \"%s\"\n",uiInfo.playerNames[uiInfo.playerIndex]) );
				trap_Cmd_ExecuteText( EXEC_APPEND, va("splat \"%i\"\n",uiInfo.playerIndexes[uiInfo.playerIndex]) );
			}
		} else if (Q_stricmp(name, "ACPfreeze") == 0) {
			if (uiInfo.playerIndex >= 0 && uiInfo.playerIndex < uiInfo.playerCount) {
				//trap_Cmd_ExecuteText( EXEC_APPEND, va("callvote kick \"%s\"\n",uiInfo.playerNames[uiInfo.playerIndex]) );
				trap_Cmd_ExecuteText( EXEC_APPEND, va("freeze \"%i\"\n",uiInfo.playerIndexes[uiInfo.playerIndex]) );
			}
		} else if (Q_stricmp(name, "ACPinsultsilence") == 0) {
			if (uiInfo.playerIndex >= 0 && uiInfo.playerIndex < uiInfo.playerCount) {
				//trap_Cmd_ExecuteText( EXEC_APPEND, va("callvote kick \"%s\"\n",uiInfo.playerNames[uiInfo.playerIndex]) );
				trap_Cmd_ExecuteText( EXEC_APPEND, va("insultsilence \"%i\"\n",uiInfo.playerIndexes[uiInfo.playerIndex]) );
			}
		} else if (Q_stricmp(name, "ACPsilence") == 0) {
			if (uiInfo.playerIndex >= 0 && uiInfo.playerIndex < uiInfo.playerCount) {
				//trap_Cmd_ExecuteText( EXEC_APPEND, va("callvote kick \"%s\"\n",uiInfo.playerNames[uiInfo.playerIndex]) );
				trap_Cmd_ExecuteText( EXEC_APPEND, va("silence \"%i\"\n",uiInfo.playerIndexes[uiInfo.playerIndex]) );
			}
		} else if (Q_stricmp(name, "ACPslay") == 0) {
			if (uiInfo.playerIndex >= 0 && uiInfo.playerIndex < uiInfo.playerCount) {
				//trap_Cmd_ExecuteText( EXEC_APPEND, va("callvote kick \"%s\"\n",uiInfo.playerNames[uiInfo.playerIndex]) );
				trap_Cmd_ExecuteText( EXEC_APPEND, va("slay \"%i\"\n",uiInfo.playerIndexes[uiInfo.playerIndex]) );
			}
		} else if (Q_stricmp(name, "ACPprotect") == 0) {
			if (uiInfo.playerIndex >= 0 && uiInfo.playerIndex < uiInfo.playerCount) {
				//trap_Cmd_ExecuteText( EXEC_APPEND, va("callvote kick \"%s\"\n",uiInfo.playerNames[uiInfo.playerIndex]) );
				trap_Cmd_ExecuteText( EXEC_APPEND, va("protect \"%i\"\n",uiInfo.playerIndexes[uiInfo.playerIndex]) );
			}
		} else if (Q_stricmp(name, "ACPkick") == 0) {
			if (uiInfo.playerIndex >= 0 && uiInfo.playerIndex < uiInfo.playerCount) {
				//trap_Cmd_ExecuteText( EXEC_APPEND, va("callvote kick \"%s\"\n",uiInfo.playerNames[uiInfo.playerIndex]) );
				trap_Cmd_ExecuteText( EXEC_APPEND, va("amkick \"%i\"\n",uiInfo.playerIndexes[uiInfo.playerIndex]) );
			}
		} else if (Q_stricmp(name, "ACPpunish") == 0) {
			if (uiInfo.playerIndex >= 0 && uiInfo.playerIndex < uiInfo.playerCount) {
				//trap_Cmd_ExecuteText( EXEC_APPEND, va("callvote kick \"%s\"\n",uiInfo.playerNames[uiInfo.playerIndex]) );
				trap_Cmd_ExecuteText( EXEC_APPEND, va("punish \"%i\"\n",uiInfo.playerIndexes[uiInfo.playerIndex]) );
			}
		} else if (Q_stricmp(name, "ACPgrant1") == 0) {
			if (uiInfo.playerIndex >= 0 && uiInfo.playerIndex < uiInfo.playerCount) {
				//trap_Cmd_ExecuteText( EXEC_APPEND, va("callvote kick \"%s\"\n",uiInfo.playerNames[uiInfo.playerIndex]) );
				trap_Cmd_ExecuteText( EXEC_APPEND, va("grantadmin \"%i\" 1\n",uiInfo.playerIndexes[uiInfo.playerIndex]) );
			}
		} else if (Q_stricmp(name, "ACPgrant2") == 0) {
			if (uiInfo.playerIndex >= 0 && uiInfo.playerIndex < uiInfo.playerCount) {
				//trap_Cmd_ExecuteText( EXEC_APPEND, va("callvote kick \"%s\"\n",uiInfo.playerNames[uiInfo.playerIndex]) );
				trap_Cmd_ExecuteText( EXEC_APPEND, va("grantadmin \"%i\" 2\n",uiInfo.playerIndexes[uiInfo.playerIndex]) );
			}
		} else if (Q_stricmp(name, "ACPgrant3") == 0) {
			if (uiInfo.playerIndex >= 0 && uiInfo.playerIndex < uiInfo.playerCount) {
				//trap_Cmd_ExecuteText( EXEC_APPEND, va("callvote kick \"%s\"\n",uiInfo.playerNames[uiInfo.playerIndex]) );
				trap_Cmd_ExecuteText( EXEC_APPEND, va("grantadmin \"%i\" 3\n",uiInfo.playerIndexes[uiInfo.playerIndex]) );
			}
		} else if (Q_stricmp(name, "ACPgrant4") == 0) {
			if (uiInfo.playerIndex >= 0 && uiInfo.playerIndex < uiInfo.playerCount) {
				//trap_Cmd_ExecuteText( EXEC_APPEND, va("callvote kick \"%s\"\n",uiInfo.playerNames[uiInfo.playerIndex]) );
				trap_Cmd_ExecuteText( EXEC_APPEND, va("grantadmin \"%i\" 4\n",uiInfo.playerIndexes[uiInfo.playerIndex]) );
			}
		} else if (Q_stricmp(name, "ACPgrant5") == 0) {
			if (uiInfo.playerIndex >= 0 && uiInfo.playerIndex < uiInfo.playerCount) {
				//trap_Cmd_ExecuteText( EXEC_APPEND, va("callvote kick \"%s\"\n",uiInfo.playerNames[uiInfo.playerIndex]) );
				trap_Cmd_ExecuteText( EXEC_APPEND, va("grantadmin \"%i\" 5\n",uiInfo.playerIndexes[uiInfo.playerIndex]) );
			}
		} else if (Q_stricmp(name, "ACPban") == 0) {
			if (uiInfo.playerIndex >= 0 && uiInfo.playerIndex < uiInfo.playerCount) {
				//trap_Cmd_ExecuteText( EXEC_APPEND, va("callvote kick \"%s\"\n",uiInfo.playerNames[uiInfo.playerIndex]) );
				trap_Cmd_ExecuteText( EXEC_APPEND, va("amban \"%i\"\n",uiInfo.playerIndexes[uiInfo.playerIndex]) );
			}
		} else if (Q_stricmp(name, "ACPdemigod") == 0) {
			if (uiInfo.playerIndex >= 0 && uiInfo.playerIndex < uiInfo.playerCount) {
				//trap_Cmd_ExecuteText( EXEC_APPEND, va("callvote kick \"%s\"\n",uiInfo.playerNames[uiInfo.playerIndex]) );
				trap_Cmd_ExecuteText( EXEC_APPEND, va("demigod \"%i\"\n",uiInfo.playerIndexes[uiInfo.playerIndex]) );
			}
		} else if (Q_stricmp(name, "ACPterminator") == 0) {
			if (uiInfo.playerIndex >= 0 && uiInfo.playerIndex < uiInfo.playerCount) {
				//trap_Cmd_ExecuteText( EXEC_APPEND, va("callvote kick \"%s\"\n",uiInfo.playerNames[uiInfo.playerIndex]) );
				trap_Cmd_ExecuteText( EXEC_APPEND, va("terminator \"%i\"\n",uiInfo.playerIndexes[uiInfo.playerIndex]) );
			}
		} else if (Q_stricmp(name, "ACPmonk") == 0) {
			if (uiInfo.playerIndex >= 0 && uiInfo.playerIndex < uiInfo.playerCount) {
				//trap_Cmd_ExecuteText( EXEC_APPEND, va("callvote kick \"%s\"\n",uiInfo.playerNames[uiInfo.playerIndex]) );
				trap_Cmd_ExecuteText( EXEC_APPEND, va("monk \"%i\"\n",uiInfo.playerIndexes[uiInfo.playerIndex]) );
			}
		} else if (Q_stricmp(name, "ACPempower") == 0) {
			if (uiInfo.playerIndex >= 0 && uiInfo.playerIndex < uiInfo.playerCount) {
				//trap_Cmd_ExecuteText( EXEC_APPEND, va("callvote kick \"%s\"\n",uiInfo.playerNames[uiInfo.playerIndex]) );
				trap_Cmd_ExecuteText( EXEC_APPEND, va("empower \"%i\"\n",uiInfo.playerIndexes[uiInfo.playerIndex]) );
			}
		} else if (Q_stricmp(name, "ACPempowerApplyALL") == 0) {
			if (uiInfo.playerIndex >= 0 && uiInfo.playerIndex < uiInfo.playerCount) {
				//trap_Cmd_ExecuteText( EXEC_APPEND, va("callvote kick \"%s\"\n",uiInfo.playerNames[uiInfo.playerIndex]) );
				trap_Cmd_ExecuteText( EXEC_APPEND, "empower +all" );
			}
		} else if (Q_stricmp(name, "ACPempowerRemoveALL") == 0) {
			if (uiInfo.playerIndex >= 0 && uiInfo.playerIndex < uiInfo.playerCount) {
				//trap_Cmd_ExecuteText( EXEC_APPEND, va("callvote kick \"%s\"\n",uiInfo.playerNames[uiInfo.playerIndex]) );
				trap_Cmd_ExecuteText( EXEC_APPEND, "empower -all" );
			}
		} else if (Q_stricmp(name, "ACPmonkApplyALL") == 0) {
			if (uiInfo.playerIndex >= 0 && uiInfo.playerIndex < uiInfo.playerCount) {
				//trap_Cmd_ExecuteText( EXEC_APPEND, va("callvote kick \"%s\"\n",uiInfo.playerNames[uiInfo.playerIndex]) );
				trap_Cmd_ExecuteText( EXEC_APPEND, "monk +all" );
			}
		} else if (Q_stricmp(name, "ACPmonkRemoveALL") == 0) {
			if (uiInfo.playerIndex >= 0 && uiInfo.playerIndex < uiInfo.playerCount) {
				//trap_Cmd_ExecuteText( EXEC_APPEND, va("callvote kick \"%s\"\n",uiInfo.playerNames[uiInfo.playerIndex]) );
				trap_Cmd_ExecuteText( EXEC_APPEND, "monk -all" );
			}
		} else if (Q_stricmp(name, "ACPterminatorApplyALL") == 0) {
			if (uiInfo.playerIndex >= 0 && uiInfo.playerIndex < uiInfo.playerCount) {
				//trap_Cmd_ExecuteText( EXEC_APPEND, va("callvote kick \"%s\"\n",uiInfo.playerNames[uiInfo.playerIndex]) );
				trap_Cmd_ExecuteText( EXEC_APPEND, "terminator +all" );
			}
		} else if (Q_stricmp(name, "ACPterminatorRemoveALL") == 0) {
			if (uiInfo.playerIndex >= 0 && uiInfo.playerIndex < uiInfo.playerCount) {
				//trap_Cmd_ExecuteText( EXEC_APPEND, va("callvote kick \"%s\"\n",uiInfo.playerNames[uiInfo.playerIndex]) );
				trap_Cmd_ExecuteText( EXEC_APPEND, "terminator -all" );
			}
		} else if (Q_stricmp(name, "ACPsilenceApplyALL") == 0) {
			if (uiInfo.playerIndex >= 0 && uiInfo.playerIndex < uiInfo.playerCount) {
				//trap_Cmd_ExecuteText( EXEC_APPEND, va("callvote kick \"%s\"\n",uiInfo.playerNames[uiInfo.playerIndex]) );
				trap_Cmd_ExecuteText( EXEC_APPEND, "silence +all" );
			}
		} else if (Q_stricmp(name, "ACPsilenceRemoveALL") == 0) {
			if (uiInfo.playerIndex >= 0 && uiInfo.playerIndex < uiInfo.playerCount) {
				//trap_Cmd_ExecuteText( EXEC_APPEND, va("callvote kick \"%s\"\n",uiInfo.playerNames[uiInfo.playerIndex]) );
				trap_Cmd_ExecuteText( EXEC_APPEND, "silence -all" );
			}
		} else if (Q_stricmp(name, "ACPprotectApplyALL") == 0) {
			if (uiInfo.playerIndex >= 0 && uiInfo.playerIndex < uiInfo.playerCount) {
				//trap_Cmd_ExecuteText( EXEC_APPEND, va("callvote kick \"%s\"\n",uiInfo.playerNames[uiInfo.playerIndex]) );
				trap_Cmd_ExecuteText( EXEC_APPEND, "protect +all" );
			}
		} else if (Q_stricmp(name, "ACPprotectRemoveALL") == 0) {
			if (uiInfo.playerIndex >= 0 && uiInfo.playerIndex < uiInfo.playerCount) {
				//trap_Cmd_ExecuteText( EXEC_APPEND, va("callvote kick \"%s\"\n",uiInfo.playerNames[uiInfo.playerIndex]) );
				trap_Cmd_ExecuteText( EXEC_APPEND, "protect -all" );
			}
		} else if (Q_stricmp(name, "ACPfreezeApplyALL") == 0) {
			if (uiInfo.playerIndex >= 0 && uiInfo.playerIndex < uiInfo.playerCount) {
				//trap_Cmd_ExecuteText( EXEC_APPEND, va("callvote kick \"%s\"\n",uiInfo.playerNames[uiInfo.playerIndex]) );
				trap_Cmd_ExecuteText( EXEC_APPEND, "freeze +all" );
			}
		} else if (Q_stricmp(name, "ACPfreezeRemoveALL") == 0) {
			if (uiInfo.playerIndex >= 0 && uiInfo.playerIndex < uiInfo.playerCount) {
				//trap_Cmd_ExecuteText( EXEC_APPEND, va("callvote kick \"%s\"\n",uiInfo.playerNames[uiInfo.playerIndex]) );
				trap_Cmd_ExecuteText( EXEC_APPEND, "freeze -all" );
			}
		} else if (Q_stricmp(name, "ACPsleepApplyALL") == 0) {
			if (uiInfo.playerIndex >= 0 && uiInfo.playerIndex < uiInfo.playerCount) {
				//trap_Cmd_ExecuteText( EXEC_APPEND, va("callvote kick \"%s\"\n",uiInfo.playerNames[uiInfo.playerIndex]) );
				trap_Cmd_ExecuteText( EXEC_APPEND, "sleep +all" );
			}
		} else if (Q_stricmp(name, "ACPsleepRemoveALL") == 0) {
			if (uiInfo.playerIndex >= 0 && uiInfo.playerIndex < uiInfo.playerCount) {
				//trap_Cmd_ExecuteText( EXEC_APPEND, va("callvote kick \"%s\"\n",uiInfo.playerNames[uiInfo.playerIndex]) );
				trap_Cmd_ExecuteText( EXEC_APPEND, "sleep -all" );
			}
		} else if (Q_stricmp(name, "ACPchangemap") == 0) {
			if (ui_netGameType.integer >= 0 && ui_netGameType.integer < uiInfo.numGameTypes &&
				ui_currentNetMap.integer >=0 && ui_currentNetMap.integer < uiInfo.mapCount) {
				trap_Cmd_ExecuteText( EXEC_APPEND, va("changemap %i %s\n", uiInfo.gameTypes[ui_netGameType.integer].gtEnum, uiInfo.mapList[ui_currentNetMap.integer].mapLoadName) );
			}
		} else if (Q_stricmp(name, "ACPforceteamRED") == 0) {
			if (uiInfo.playerIndex >= 0 && uiInfo.playerIndex < uiInfo.playerCount) {
				trap_Cmd_ExecuteText( EXEC_APPEND, va("forceteam \"%i\" red\n", uiInfo.playerIndexes[uiInfo.playerIndex]) );
			}
		} else if (Q_stricmp(name, "ACPforceteamBLUE") == 0) {
			if (uiInfo.playerIndex >= 0 && uiInfo.playerIndex < uiInfo.playerCount) {
				trap_Cmd_ExecuteText( EXEC_APPEND, va("forceteam \"%i\" blue\n", uiInfo.playerIndexes[uiInfo.playerIndex]) );
			}
		} else if (Q_stricmp(name, "ACPforceteamSPEC") == 0) {
			if (uiInfo.playerIndex >= 0 && uiInfo.playerIndex < uiInfo.playerCount) {
				trap_Cmd_ExecuteText( EXEC_APPEND, va("forceteam \"%i\" spectator\n", uiInfo.playerIndexes[uiInfo.playerIndex]) );
			}
		} else if (Q_stricmp(name, "ACPforceteamFREE") == 0) {
			if (uiInfo.playerIndex >= 0 && uiInfo.playerIndex < uiInfo.playerCount) {
				trap_Cmd_ExecuteText( EXEC_APPEND, va("forceteam \"%i\" free\n", uiInfo.playerIndexes[uiInfo.playerIndex]) );
			}
		} else if (Q_stricmp(name, "ACPlockteamRED") == 0) {
			trap_Cmd_ExecuteText( EXEC_APPEND, "lockteam red\n" );
		} else if (Q_stricmp(name, "ACPlockteamBLUE") == 0) {
			trap_Cmd_ExecuteText( EXEC_APPEND, "lockteam blue\n" );
		} else if (Q_stricmp(name, "ACPlockteamSPEC") == 0) {
			trap_Cmd_ExecuteText( EXEC_APPEND, "lockteam spectator\n" );
		} else if (Q_stricmp(name, "ACPlockteamFREE") == 0) {
				trap_Cmd_ExecuteText( EXEC_APPEND, "lockteam free\n" );
		} else if (Q_stricmp(name, "ACPchangemodematch") == 0) {
			trap_Cmd_ExecuteText( EXEC_APPEND, "changemode clanmatch\n" );
		} else if (Q_stricmp(name, "ACPchangemodemeeting") == 0) {
			trap_Cmd_ExecuteText( EXEC_APPEND, "changemode clanmeeting\n" );
		} else if (Q_stricmp(name, "ACPchangemodeclear") == 0) {
			trap_Cmd_ExecuteText( EXEC_APPEND, "changemode clear\n" );
		...
		} else if (Q_stricmp(name, "voteModControl") == 0) {
			if (uiInfo.voteIndex >= 0 && uiInfo.voteIndex < uiInfo.voteCount) {
				trap_Cmd_ExecuteText( EXEC_APPEND, va("callvote modcontrol \"%i\"\n",uiInfo.voteIndex) );
			}
		} else if (Q_stricmp(name, "voteSleep") == 0) {
			if (uiInfo.playerIndex >= 0 && uiInfo.playerIndex < uiInfo.playerCount) {
				trap_Cmd_ExecuteText( EXEC_APPEND, va("callvote sleep \"%i\"\n",uiInfo.playerIndexes[uiInfo.playerIndex]) );
			}
		} else if (Q_stricmp(name, "voteSilence") == 0) {
			if (uiInfo.playerIndex >= 0 && uiInfo.playerIndex < uiInfo.playerCount) {
				trap_Cmd_ExecuteText( EXEC_APPEND, va("callvote silence \"%i\"\n",uiInfo.playerIndexes[uiInfo.playerIndex]) );
			}
...
//			int oldteam = (int)trap_Cvar_VariableValue("ui_startsiegeteam");
		...
		{
			UI_ClampMaxPlayers();
		// mine added here (-at-)  Add UI script/UI commands
		} else {
...
static int UI_FeederCount(float feederID) 
{
	...
	switch ( (int)feederID )
	{
		...
		case FEEDER_VOTES:  //lmo for enhanced voting
			UI_BuildVoteList();
			return uiInfo.voteCount;
...
static const char *UI_FeederItemText(float feederID, int index, int column, 
	...
	*handle1 = *handle2 = *handle3 = -1;
	...
	} else if (feederID == FEEDER_VOTES) {
		if (index >= 0 && index < uiInfo.voteCount) {
			return uiInfo.votes[index];
		}
...
void _UI_Init( qboolean inGameLoad ) {
  ...
  uiInfo.aliasCount = 0;
	...
	//trap_Cvar_Register(NULL, "ui_clan", UI_Cvar_VariableString("clan"), CVAR_INTERNAL );
	//cm - Dom Added Rank
	//trap_Cvar_Register(NULL, "ui_rank", UI_Cvar_VariableString("rank"), CVAR_INTERNAL );
	trap_Cvar_Register(NULL, "ui_clanicon", UI_Cvar_VariableString("c_clanicon"), CVAR_INTERNAL ); //1st layer (client)
	trap_Cvar_Register(NULL, "ui_clanicon2", UI_Cvar_VariableString("c_clanicon2"), CVAR_INTERNAL ); //2nd layer (client)
	//RoAR mod [Admin CP]
	trap_Cvar_Register(NULL, "ui_adminpass", UI_Cvar_VariableString("c_Adminpassword"), CVAR_INTERNAL );
...
//				UI_LoadNonIngame();
	  ...
	  case UIMENU_CREDITS:
			trap_Key_SetCatcher( KEYCATCH_UI );
			Menus_CloseAll();
			Menus_ActivateByName("cm_credits");
		  return;
	  //RoAR mod [Admin CP]
	  case UIMENU_ACP:
			trap_Key_SetCatcher( KEYCATCH_UI );
			Menus_CloseAll();
			Menus_ActivateByName("ingame_acp");
		  return;
	  }
  }
}
...
//cm - Dom Added Rank
//vmCvar_t	ui_rank;
vmCvar_t	ui_clanicon; //1st layer (client)
vmCvar_t	ui_clanicon2; //2nd layer (client)
#ifdef _XBOX
...
//END JLFCALLOUT
// LMO DUELERS
	{ &ui_votecount, "ui_votecount", "0", 0}, //for enhanced votes
	{ &ui_vote1, "ui_vote1", "", 0}, //for enhanced votes
	{ &ui_vote2, "ui_vote2", "", 0}, //for enhanced votes
	{ &ui_vote3, "ui_vote3", "", 0}, //for enhanced votes
	{ &ui_vote4, "ui_vote4", "", 0}, //for enhanced votes
	{ &ui_vote5, "ui_vote5", "", 0}, //for enhanced votes
	{ &ui_vote6, "ui_vote6", "", 0}, //for enhanced votes
// DUELERS
//[RGBSabers]
	...
	//{ &ui_rank,				"ui_rank", "",	CVAR_INTERNAL},
	{ &ui_clanicon,			"ui_clanicon", "none", CVAR_INTERNAL},
	{ &ui_clanicon2,		"ui_clanicon2", "none", CVAR_INTERNAL},
//[/RGBSabers]
};
