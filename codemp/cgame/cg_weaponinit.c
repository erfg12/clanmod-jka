...
void CG_GrappleTrail( centity_t *ent, const weaponInfo_t *wi ) {
	...
	//if (Distance( from, to ) < 64 )
	//	return; // Don't draw if close

	trap_FX_AddLine( from, to, 0.1f, 7.0f, 0.0f, 
							1.0f, 0.0f, 0.0f,
							YELLER, YELLER, 0.0f,
...
//==============================grapplemod==========================
	//	weaponInfo->altFlashSound[0] = trap_S_RegisterSound( "sound/weapons/baton/fire.mp3" );
		...
		weaponInfo->missileModel = trap_R_RegisterModel( "models/items/hook.md3" );//models/ammo/rocket/rocket.md3" );
		//weaponInfo->missileModel = trap_R_RegisterModel( "models/items/remote.md3" );//models/ammo/rocket/rocket.md3" );
//		weaponInfo->missileTrailFunc = CG_GrappleTrail;
		//weaponInfo->missileDlight = 200;
		weaponInfo->wiTrailTime = 2000;
		weaponInfo->trailRadius = 10;//weaponInfo->trailRadius = 64;
		MAKERGB( weaponInfo->missileDlightColor, 0.7f, 0.7f, 0.7f );
	//	weaponInfo->readySound = trap_S_RegisterSound( "sound/weapons/melee/fsthum.wav", qfalse );
	//	weaponInfo->firingSound = trap_S_RegisterSound( "sound/weapons/melee/fstrun.wav", qfalse );
	//	cgs.media.lightningShader=trap_R_RegisterShader( "gfx/misc/electric2" );
	case WP_MELEE:
