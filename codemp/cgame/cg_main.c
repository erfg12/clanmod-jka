...
vmCvar_t	c_chatColor;

//vmCvar_t	ojp_clientplugin10; //v1.10 BETA2

vmCvar_t	clan;
vmCvar_t	rank;
vmCvar_t	c_chatmode;
vmCvar_t	c_Clanpassword;
vmCvar_t	c_Adminpassword;
vmCvar_t	c_clanicon;
...
static cvarTable_t cvarTable[] = { // bk001129
	...
	{ &cg_dismember, "cg_dismember", "100", CVAR_ARCHIVE },
	...
	//{ &cg_clanrankview,	"cg_clanrankview",	"0", CVAR_ARCHIVE},
...
*/
//[RGBSabers]
	//{ &clan,	"clan", "", CVAR_USERINFO | CVAR_ARCHIVE },
	//{ &rank,	"rank", "", CVAR_USERINFO | CVAR_ARCHIVE },
...
//[/RGBSabers]
	{ &c_Clanpassword,  "c_Clanpassword", "", CVAR_USERINFO | CVAR_ARCHIVE},
	{ &c_Adminpassword,  "c_Adminpassword", "", CVAR_USERINFO | CVAR_ARCHIVE},
	{ &c_chatColor,  "c_chatColor", "green", CVAR_USERINFO | CVAR_ARCHIVE},
	//{ &ojp_clientplugin10, "ojp_clientplugin10", CURRENT_OJPENHANCED_CLIENTVERSION9, CVAR_USERINFO | CVAR_ARCHIVE | CVAR_ROM },
	{ &c_chatmode,  "c_chatmode", "team", CVAR_USERINFO | CVAR_ARCHIVE},
...
//	CG_LoadFonts();
	...
	memset( cg_dueltypes, 0, sizeof(cg_dueltypes) ); //lmo for duel types
