...
#define	FL_ADMINLOGS			0x00000040
...
typedef struct {
	...
	int			clanIcon;			//RoAR mod NOTE: This is a session mark for clan icons!
	int			clanIcon2;			//Layer 2
...
typedef struct {
	...
	qboolean	modeMeeting;			// RoAR mod : Clan Meeting mode.
	qboolean	modeClanMatch;			// RoAR mod : Clan Match Mode.
...
gentity_t	*G_PlayEffect(int fxID, vec3_t org, vec3_t ang, int owner);
...
//void Spec_n_ClientActions	( gentity_t *ent, int msec );
...
extern qboolean IsJedi( gentity_t *ent );
...
extern	vmCvar_t	cm_DuelForceRegenTime;
...
extern	vmCvar_t	g_filterAdminBan;
...
extern	vmCvar_t	saberChangeProtectTime;
...
extern	vmCvar_t	m_v3;
extern	vmCvar_t	m_v4;
extern	vmCvar_t	m_v5;
...
extern	vmCvar_t	cm_DISRUPTOR_ALT_DAMAGE;
extern	vmCvar_t	cm_BOWCASTER_DAMAGE;
extern	vmCvar_t	cm_REPEATER_DAMAGE;
extern	vmCvar_t	cm_REPEATER_ALT_DAMAGE;
extern	vmCvar_t	cm_REPEATER_SPLASH_DAMAGE;
extern	vmCvar_t	cm_REPEATER_VELOCITY;
extern	vmCvar_t	cm_BOWCASTER_VELOCITY;
extern	vmCvar_t	cm_DEMP2_DAMAGE;
extern	vmCvar_t	cm_DEMP2_ALT_DAMAGE;
extern	vmCvar_t	cm_DEMP2_VELOCITY;
extern	vmCvar_t	cm_FLECHETTE_DAMAGE;
extern	vmCvar_t	cm_FLECHETTE_ALT_DAMAGE;
extern	vmCvar_t	cm_FLECHETTE_VELOCITY;
extern	vmCvar_t	cm_ROCKET_DAMAGE;
extern	vmCvar_t	cm_ROCKET_SPLASH_DAMAGE;
extern	vmCvar_t	cm_ROCKET_VELOCITY;
extern	vmCvar_t	cm_CONCUSION_DAMAGE;
extern	vmCvar_t	cm_CONCUSION_SPLASH_DAMAGE;
extern	vmCvar_t	cm_CONCUSION_ALT_DAMAGE;
extern	vmCvar_t	cm_CONCUSION_VELOCITY;
extern	vmCvar_t	cm_STUN_BATON_DAMAGE;
extern	vmCvar_t	cm_MELEE_SWING1_DAMAGE;
extern	vmCvar_t	cm_MELEE_SWING2_DAMAGE;
extern	vmCvar_t	cm_THERMAL_DETONATOR_DAMAGE;
extern	vmCvar_t	cm_THERMAL_DETONATOR_ALT_DAMAGE;
extern	vmCvar_t	cm_THERMAL_DETONATOR_VELOCITY;
extern	vmCvar_t	cm_TRIP_MINE_DAMAGE;
extern	vmCvar_t	cm_DET_PACK_DAMAGE;
extern	vmCvar_t	cm_DET_PACK_SPLASH_DAMAGE;

extern	vmCvar_t	cm_BRYAR_PISTOL_DAMAGE;
extern	vmCvar_t	cm_BRYAR_PISTOL_VELOCITY;

extern	vmCvar_t	g_NPCmaxFollowers;
...
extern vmCvar_t		roar_rename_saying;
...
extern vmCvar_t		cm_tagwarnings;
...
extern vmCvar_t		cm_allow_report_command;
extern vmCvar_t		roar_allow_dropsaber_command;
extern vmCvar_t		cm_empower_infforce;
...
extern vmCvar_t		cm_adminPassword4;
extern vmCvar_t		cm_adminPassword5;
extern vmCvar_t		cm_clanPassword;

extern vmCvar_t		cm_extensionsIP;
extern vmCvar_t		cm_extensionsPort;
...
extern vmCvar_t		cm_adminlogin4_saying;
extern vmCvar_t		cm_adminlogin5_saying;

extern vmCvar_t		cm_adminlogout1_saying;
extern vmCvar_t		cm_adminlogout2_saying;
extern vmCvar_t		cm_adminlogout3_saying;
extern vmCvar_t		cm_adminlogout4_saying;
extern vmCvar_t		cm_adminlogout5_saying;

extern vmCvar_t		cm_adminControl1;
extern vmCvar_t		cm_adminControl2;
extern vmCvar_t		cm_adminControl3;
extern vmCvar_t		cm_adminControl4;
extern vmCvar_t		cm_adminControl5;

extern vmCvar_t		cm_AllowKnockDownPull;

extern vmCvar_t		cm_customSaberDmgs;

extern vmCvar_t		roar_allow_KnockMeDown_command;

extern vmCvar_t		cm_spillpassword;

extern vmCvar_t		roar_allow_auto_saber_switching;

extern vmCvar_t		roar_spectate_keep_score;

extern vmCvar_t		cm_password_latch;
...
typedef struct {
	char votestring[MAX_NAME_LENGTH];
	char voteexec[MAX_CVAR_VALUE_STRING];
} mod_votes_t;

extern mod_votes_t mod_votes[MAX_VOTES]; // for extended vote configuration
extern int mod_votes_count;
...
//lmo reroute syscall for duel non interference
...
#define trap_G2Trace(a,b,c,d,e,f,g,h,i) nox_trap_G2Trace(a,b,c,d,e,f,g,h,i)
...
//cm - Dom
//Buffers for reserved names/passwords
extern char *reserved[1024];
extern char *reservedPass[1024];
extern int numNames;
